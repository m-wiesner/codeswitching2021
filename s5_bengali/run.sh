...
data=/export/corpora5/MultilingualCodeSwitching2021/codeswitching/104/Bengali-English
...
if [ $stage -le 3 ] && [ ${stop_stage} -ge 3 ]; then
  ### Monophone
  echo "mono training"
  steps/train_mono.sh --boost-silence 1.25 --nj 15 --cmd "$train_cmd" data/train_500short data/lang_${lexicon_type}_nosp exp/mono
fi
...
if [ $stage -le 7 ] && [ ${stop_stage} -ge 7 ]; then
  steps/align_si.sh --use-graphs true --nj 30 --cmd "$train_cmd" \
